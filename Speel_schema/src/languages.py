LANGUAGES = {
    "en": {
        ...
        "error_unable_to_generate_schedule": "Unable to generate schedule after {locations} locations, {players} players, {required_players} required players, {max_consecutive_games} max consecutive games, and {max_games} max games.",
    ...
    "nl": {
        ...
        "error_unable_to_generate_schedule": "Kan geen schema genereren na {locations} locaties, {players} spelers, {required_players} vereiste spelers, {max_consecutive_games} max opeenvolgende wedstrijden, en {max_games} max wedstrijden.",
